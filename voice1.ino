...
// ⚠️ Note: Disconnect Bluetooth module while uploading
...
// Track light and woofer states (initially OFF)
...
void setup() {
    ...
    // Ensure all relays are OFF at startup (active LOW logic)
...
void updateLCD() {
    ...
    if (countOn == 0) {
        ...
        if (bathroomState) { lcd.setCursor(0, 1); lcd.print("Bathroom ON "); }
